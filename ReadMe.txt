...
your_domain/geo-ip/country/<ip> - для получения данных по стране
your_domain/geo-ip/network/<ip> - для получения сети для заданного ip
...
your_domain/geo-ip/get-records
